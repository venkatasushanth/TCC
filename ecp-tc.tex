...
Overall, the worst penalties were the 47\% increase in delays in Sum output at near-threshold operation, 59\% increase on delay deviation in the Carry Out output at nominal operation, 93\% increase at energy consumption for Sum output at both operation regimes and its 47\% increase in energy deviation at nominal operation. Energy penalties are plotted at Figures \ref{fig:energyNominal} to \ref{fig:energyNT}. 



\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{energyNominal.png}
\caption{Energy penalties at nominal operation due to the technique application.}
\label{fig:energyNominal}
\legend{Source: From the author.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{energyNT.png}
\caption{Energy penalties at near-threshold operation due to the technique application.}
\label{fig:energyNT}
\legend{Source: From the author.}
\end{figure}
...
\begin{tabular}{llcc}
\hline
\multicolumn{2}{l}{\textbf{}} & \textbf{Nominal} & \textbf{NT} \\ \hline
\multicolumn{2}{l}{\textbf{Highest Accumulated Robustness Improvement}} & Hybrid (70\%) & Hybrid (122\%) \\ \hline
\multicolumn{2}{l}{\textbf{Highest Accumulated Robustness Improvement}} & TGA (39.15\%) & CMOS (62.38\%) \\ \hline
\multirow{2}{*}{\textbf{Lowest Variability Sensitivity without the ST technique}} & Delay & CMOS (22.46\%) & CMOS (72.43\%) \\ \cline{2-4} 
 & Energy & CMOS (20\%) & TFA (25.85\%) \\ \hline
\multirow{2}{*}{\textbf{Lowest Variability Sensitivity with the ST technique}} & Delay & CMOS (21.82\%) & CMOS (61.3\%) \\ \cline{2-4} 
 & Energy & Hybrid (15.6\%) & TFA (10.41\%) \\ \hline
\multirow{2}{*}{\textbf{Highest Variability Sensitivity without the ST technique}} & Delay & TFA (68.27\%) & TFA (258.45\%) \\ \cline{2-4} 
 & Energy & TGA (25.33\%) & TGA (31\%) \\ \hline
\multirow{2}{*}{\textbf{Highest Variability Sensitivity with the ST technique}} & Delay & TFA (67.18\%) & TFA (188.84\%) \\ \cline{2-4} 
 & Energy & TGA (20.16\%) & CMOS (22\%) \\ \hline
\end{tabular}%
}
\end{table}
